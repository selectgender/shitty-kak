...
declare-option str base00 'rgb:59251d'
declare-option str base01 'rgb:722c21'
declare-option str base02 'rgb:8c3b2e'
declare-option str base03 'rgb:a44b3d'
declare-option str base04 'rgb:b95c4e'
declare-option str base05 'rgb:cb6e60'
declare-option str base06 'rgb:db8274'
declare-option str base07 'rgb:e89689'
declare-option str base08 'rgb:f2aba1'
declare-option str base09 'rgb:f2aba1'
declare-option str base0A 'rgb:e5d390'
declare-option str base0B 'rgb:a8d58a'
declare-option str base0C 'rgb:8bddaf'
declare-option str base0D 'rgb:8dd3de'
declare-option str base0E 'rgb:acbefa'
declare-option str base0F 'rgb:d7a9f4'
...
set-face global MenuForeground "%opt{base01},%opt{base07}+b"
set-face global MenuBackground "%opt{base07},%opt{base01}"
set-face global MenuInfo "%opt{base0D},%opt{base01}"
